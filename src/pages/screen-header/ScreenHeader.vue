        ...
        <div class="screen-header-top-section">
            ...
            <div class="screen-header-title-section">
                ...
                <div class="title-section">
                    <!-- <p class="header-title">冰箱装配生产线</p> -->
        ...
        <div class="screen-header-bottom-section">
            <div class="sub-section">
                <div class="sub-item flex-l sub-item-common-r">
                    ...
                    <span class="sub-title special">生产{{linename}}线</span>
                </div>
            ...
            <div class="sub-section">
                <div class="sub-item flex-c react-r item-special">
                    ...
                    <span class="sub-title">
                        PLC状态:
                        <i class="iconfont icon-early-warning" style="margin-left: 10px;" :style="{'color':data.plclinkscolor}"/>
                    </span>
                </div>
                <div class="sub-item flex-r sub-item-common-l">
                    <span
                        class="sub-title">{{data.dateYear}}&nbsp;&nbsp;{{data.dateDay}}&nbsp;&nbsp;{{data.dateWeek}}</span>
                </div>
            </div>
        </div>
    </div>
...
import { getHeader } from "@/utils/getdatautil"; //微软signalr
...
const data = reactive({
    ...
    dateWeek: '',
    plclinkstatus:false,
    plclinkscolor:"gainsboro",
})
const WEEK = ['周日', '周一', '周二', '周三', '周四', '周五', '周六']

onMounted(() => {

    getHeader(props.module,data);
